"""
Django settings for hh_it project.
...
SECRET_KEY = 'django-insecure-e(d76k_)9xwy(ylg2@_p8t1!o=y6bf9n3#mc%$5vhymmo9hj3$'
...
WSGI_APPLICATION = 'hh_it.wsgi.application'
